  ...
  },
  {
    ...
    config = function()
      require('nvim-highlight-colors').setup {
        ...
        enable_named_colors = true, -- Allows named colors (e.g., 'red', 'blue')
        enable_tailwind = false, -- Only needed if using Tailwind CSS color classes
        enable_python_ansi = true,
      }
    end,
  },
